...
class CustomLoginView(LoginView):
    template_name = 'login.html'  # Your login template path
    
    def post(self, request, *args, **kwargs):
        email = request.POST.get('username')  # Django expects 'username' name
...
class VendorCreateView(LoginRequiredMixin,  UserPassesTestMixin, CreateView):
    ...
    def test_func(self):
        """Only allow superusers to create vendors"""
        return self.request.user.is_superuser
...
class VendorUpdateView(LoginRequiredMixin,  UserPassesTestMixin, UpdateView):
    ...
    success_url = reverse_lazy('vendor-list')
    def test_func(self):
        """Only allow superusers or vendor owners to update"""
