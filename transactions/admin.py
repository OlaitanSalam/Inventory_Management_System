...
class SaleAdmin(admin.ModelAdmin):
    list_display = ('store', 'date_added', 'grand_total', 'amount_paid', 'amount_change', 'cashier', 'receipt_number', 'customer')
...
class PurchaseOrderAdmin(admin.ModelAdmin):
    list_display = ('id', 'vendor', 'order_date', 'delivery_date', 'delivery_status', 'total_value')
